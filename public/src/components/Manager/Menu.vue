<template>
  <v-layout row>
    <v-flex x12 lg8 offset-lg2>
      <v-layout row wrap>
        <v-flex xs12 sm6 px-5 py-2 v-for="item in items" :key="item.name">
          <v-btn
            large block
            color="blue-grey"
            class="white--text"
